package com.core.exception03.revisao.runtime;

import com.core.exception03.revisao.dominio.IllegalArgument;

import java.util.Scanner;

/*
verifica em tempo de execução que o método foi
chamado em um momento ou estado inadequado do objeto
 */
